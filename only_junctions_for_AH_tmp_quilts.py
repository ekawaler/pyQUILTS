...
def translate_seq(sequence, strand, return_all = False):
	...
	for i in range(0,len(sequence)-2,3):
		if sequence[i:i+3] == 'EGN':
			print sequence, strand
		translated += codon_map[sequence[i:i+3]]
...
if __name__ == "__main__":
	...
	shutil.copytree("/ifs/data/proteomics/tcga/scripts/quilts/pyquilts/results_20180227.154745/log/", results_folder+"/log/")
