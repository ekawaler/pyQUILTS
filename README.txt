...
python quilts.py
	...
	—-junction (path to a folder containing junction files, .bed if tophat or .txt if map splice)
	—-mapsplice (if this argument is present, will look for junctions.txt instead of junctions.bed)
